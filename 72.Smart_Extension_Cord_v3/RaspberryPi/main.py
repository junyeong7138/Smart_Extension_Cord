...
def main():
    ...
    #   버튼2(GPIO6): 무조건 전체 OFF (on_all_off)
    button1 = TouchSensor(pin=5, on_press=orchestrator.on_touch, name="BUTTON1")
    button2 = TouchSensor(pin=6, on_press=orchestrator.on_all_off, name="BUTTON2")
